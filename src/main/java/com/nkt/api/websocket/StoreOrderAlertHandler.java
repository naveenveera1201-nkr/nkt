 ...
 * wss://api.nammakadaitheru.in/ws/store/orders
...
public class StoreOrderAlertHandler extends TextWebSocketHandler {
    ...
    /** Called by StoreOrderService (or a messaging broker) when a new order arrives */
    public void pushNewOrder(String storeOwnerId, Order order) {
        ...
        if (session != null && session.isOpen()) {
            ...
            } catch (Exception e) { log.warn("Failed to push order alert to store {}", storeOwnerId); }
        }
    }
